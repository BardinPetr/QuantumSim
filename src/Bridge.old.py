...
class Bridge(Eventable):
    ...
    def register_key_manager(self, ip, key_manager):
        self.cryptos[ip] = Crypto(key_manager)

        key_manager.bind_bridge(self.request_data, ip, self.user_mode)
...
if __name__ == '__main__':
    ...
    b1 = Bridge('192.168.8.100', '10.10.10.10', '255.255.255.0', in_port=50001)
    b1.register_crypto('192.168.8.102', c0)
    b1.connect('192.168.8.102', 51002)
